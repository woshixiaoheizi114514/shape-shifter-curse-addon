	...
	public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
		...
		if (!world.isClient && user instanceof ServerPlayerEntity serverPlayer) {
			...
			if (target != null) {
				...
				if (!net.jackcooper.shapeShifterCurseAddon.util.WhitelistUtils.isBuffTarget(serverPlayer, target)) {
				...
				if (hasLineOfSight) {
					...
					net.jackcooper.shapeShifterCurseAddon.util.ParticleUtils.spawnParticles(serverWorld, ParticleTypes.HEART,
