package net.jackcooper.shapeShifterCurseAddon.client.colorpicker;
...
public class AdvancedColorScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.translatable("text.ssc_addon.adv_color.btn.to_presets"),
                b -> MinecraftClient.getInstance().setScreen(
                        new net.jackcooper.shapeShifterCurseAddon.client.palette.PalettePresetsScreen(this)
    ...
    private void maybeShowTutorial() {
        ...
        String saveId = net.jackcooper.shapeShifterCurseAddon.util.ClientSaveUtils.getCurrentSaveId();
        net.jackcooper.shapeShifterCurseAddon.config.SSCAddonClientConfig cfg =
                me.shedaniel.autoconfig.AutoConfig.getConfigHolder(
                        net.jackcooper.shapeShifterCurseAddon.config.SSCAddonClientConfig.class).getConfig();
        ...
        Runnable markSeen = () -> {
            if (!cfg.colorTutorialSeenSaves.contains(saveId)) {
                ...
                me.shedaniel.autoconfig.AutoConfig.getConfigHolder(
                        net.jackcooper.shapeShifterCurseAddon.config.SSCAddonClientConfig.class).save();
            }
        };
    ...
    public void applyPaletteData(net.jackcooper.shapeShifterCurseAddon.palette.PaletteCodec.PaletteData data) {
        if (working == null) {
            this.initialSnapshot = AdvancedColorBridge.snapshotFromConfig();
            this.working = initialSnapshot.copy();
            this.previewBackup = AdvancedColorBridge.backupPreview();
    ...
    private static class UnsavedConfirmScreen extends Screen {
        ...
        public void tick() {
            ...
            net.jackcooper.shapeShifterCurseAddon.client.colorpicker.AdvancedColorBridge
