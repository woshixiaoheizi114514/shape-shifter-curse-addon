...
public class TrueInvisibilityDashAbilityPower extends ActiveCooldownPower {
	...
	private void performStunEffect() {
		...
		// Particle effect
		net.jackcooper.shapeShifterCurseAddon.util.ParticleUtils.spawnParticles(world, net.minecraft.particle.ParticleTypes.POOF,
				entity.getX(), entity.getY(), entity.getZ(), 15, 0.8, 0.2, 0.8, 0.1);
		net.jackcooper.shapeShifterCurseAddon.util.ParticleUtils.spawnParticles(world, net.minecraft.particle.ParticleTypes.CLOUD,
