...
public class SSCAddonConfigMenuScreen extends Screen {
	...
	protected void init() {
		...
		addBtn(xPos, yPos, btnW, btnH,
				...
				() -> new net.jackcooper.shapeShifterCurseAddon.client.keybind.SscAddonKeybindFormListScreen(this));
		yPos += btnH + gap;
		...
		if (showColorBtn) {
			addBtn(xPos, yPos, btnW, btnH,
					...
					() -> new net.jackcooper.shapeShifterCurseAddon.client.colorpicker.AdvancedColorScreen(this));
			yPos += btnH + gap;
		}
